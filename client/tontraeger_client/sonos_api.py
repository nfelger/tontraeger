...
class SonosAPI:
    ...
    def _find_speaker(self) -> SoCo:
        ...
        if not speaker:
            ...
            raise RuntimeError(f"Speaker '{self.speaker_name}' not found. Available: {available}")
        return speaker
    ...
    def _do_play(self, uri: str) -> None:
        ...
        # Spotify/music service share links are HTTPS URLs and need the
        # ShareLinkPlugin. All other URIs (Sonos-native, radio, etc.)
        # go through add_uri_to_queue.
